...
public class CastingMain {
	...
	public static void main(String[] args) {
		...
		dnum = 3.14;
		inum3 = (int)dnum;
		System.out.println("double : " + dnum + " -> inum3 : " + inum3); // 정수만 표시되어서 손실 발생.
		...
		System.out.println(inum3 = (int)dnum1 + (int)fnum1); // 1+0 형변환 후 연산. 1
		
		System.out.println(inum2 = (int)(dnum1 + fnum1)); // 1.2 + 0.9 = 2.1 후 형변환 2
